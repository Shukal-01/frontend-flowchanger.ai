                                        ...
                                        <div className="flex xl:justify-center justify-start items-center">
                                            ...
                                            <button
                                                onClick={() => {
                                                    ...
                                                    setFine({
                                                        ...fine,
                                                        earlyOutAmount: record?.fine?.earlyOutAmount || 1,
                                                        earlyOutFineAmount: (record?.fine?.earlyOutFineAmount / (record?.fine?.earlyOutAmount || 1)) || 0,
                                                        earlyOutHour: record?.fine?.earlyOutFineHoursTime || "00:00",
                                                        lateEntryAmount: record?.fine?.lateEntryAmount || 1,
                                                        lateEntryFineAmount: (record?.fine?.lateEntryFineAmount / (record?.fine?.lateEntryAmount || 1)) || 0,
                                                        lateEntryHour: record?.fine?.lateEntryFineHoursTime || "00:00",
                                                        excessBreakAmount: record?.fine?.excessBreakAmount || 1,
                                                        excessBreakFineAmount: (record?.fine?.excessBreakFineAmount / (record?.fine?.excessBreakAmount || 1)) || 0,
                                                        excessBreakHour: record?.fine?.excessBreakFineHoursTime || "00:00",
                                                        shiftIds: record?.fine?.shiftIds,
                                                    });
                                                }}
                                                className={
                                                        ...
                                                        <div className=" p-[10px]   ">
                                                            ...
                                                            <div className="flex items-center gap-[20px]">
                                                                <div>
                                                                    ...
                                                                    <TimePicker
                                                                        placeholder={fine.lateEntryHour || "00:00"}
                                                                        showSecond={false}
                                                                        format="HH:mm"
                                                                        inputReadOnly
                                                                        onChange={(time) => {
                                                        ...
                                                        <div className="p-[10px] ">
                                                            ...
                                                            <div className="flex items-center gap-[20px]">
                                                                <div>
                                                                    <p className="text-[12px]">Hours</p>
                                                                    <TimePicker
                                                                        placeholder={fine?.excessBreakHour || "00:00"}
                                                                        showSecond={false}
                                                                        format="HH:mm"
                                                                        inputReadOnly
                                                                        onChange={(time) => {
                                                        ...
                                                        <div className="p-[10px] ">
                                                            ...
                                                            <div className="flex items-center gap-[20px]">
                                                                <div>
                                                                    <p className="text-[12px]">Hours</p>
                                                                    <TimePicker
                                                                        placeholder={fine?.earlyOutHour || "00:00"}
                                                                        showSecond={false}
                                                                        format="HH:mm"
                                                                        inputReadOnly
                                                                        onChange={(time) => {
                                        ...
                                        <div className="flex justify-center items-center">
                                            ...
                                            <button
                                                onClick={() => {
                                                    ...
                                                    setOverTime({
                                                        ...overTime,
                                                        lateEntryHour: record?.Overtime?.lateOutOvertimeHoursTime || "00:00",
                                                        earlyOutHour: record?.Overtime?.earlyCommingEntryHoursTime || "00:00",
                                                        lateEntryFineAmount: record?.Overtime?.lateOutAmount / record?.Overtime?.lateOutOvertimeAmount || 0,
                                                        lateEntryAmount: record?.Overtime?.lateOutOvertimeAmount || 1,
                                                        earlyOutFineAmount: record?.Overtime?.earlyCommingEntryAmount || 0,
                                                        earlyOutAmount: record?.Overtime?.earlyEntryAmount / record?.Overtime?.earlyCommingEntryAmount || 1,
                                                        shiftIds: record?.Overtime?.shiftIds,
                                                    })
                                                    console.log(record)
                                                }}
                                                className={
                                            ...
                                            {isOpen12 && ((
                                                ...
                                                return <div className="fixed inset-0 z-50 p-[10px] flex items-center justify-center bg-black bg-opacity-50">
                                                        ...
                                                        <div className="p-[10px] ">
                                                            ...
                                                            <div className="flex items-center gap-[20px]">
                                                                <div>
                                                                    <p className="text-[12px]">Hours</p>
                                                                    <TimePicker
                                                                        placeholder={overTime?.lateEntryHour || "00:00"}
                                                                        showSecond={false}
                                                                        format="HH:mm"
                                                                        onChange={(time) => {
                                                                            const value = time
                                                        ...
                                                        <div className="p-[10px] ">
                                                            ...
                                                            <div className="flex items-center gap-[20px]">
                                                                <div>
                                                                    <p className="text-[12px]">Hours</p>
                                                                    <TimePicker
                                                                        placeholder={overTime?.earlyOutHour || "00:00"}
                                                                        showSecond={false}
                                                                        format="HH:mm"
                                                                        inputReadOnly
                                                                        onChange={(time) => {

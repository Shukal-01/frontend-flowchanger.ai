...
export default function DropdownMenu() {
  ...
  return (
    <div className="relative text-right">
      ...
      <AttendenceSetting open={openAttendenceSetting} setOpen={setOpenAttendenceSetting} />

      <div className="flex justify-between gap-2 md:gap-5 flex-wrap items-center">
        <div className="flex gap-[10px] summary-bold">
          <h1 className="font-semibold summary-attend whitespace-nowrap">Attendence Summary</h1>
        </div>
        <div className="flex gap-2 flex-wrap">
          <button className=" text-[#8e54c2] mr-[10px] text-[14px] font-semibold" to="#">
      ...
      {isOpen && (
        <div className="absolute z-10 mt-2 bg-white border rounded-md shadow-lg right-[24px] w-[500px]">
          <ul>
            <li className="p[0] ">
              <Link onClick={() => setOpenAttendenceSetting(true)} className="flex items-center justify-between p-4 hover:bg-gray-50 cursor-pointer ">
            ...
            <li className="p-[0]">
              <Link to="#"  onClick={() => setOpenDailyWork(true)} className="flex  items-center justify-between p-4 hover:bg-gray-50 cursor-pointer ">
                <span
            ...
            <li className="p-[0] ">
              <Link onClick={() => setOpenTrackTime(true)} className="flex items-center justify-between p-4 hover:bg-gray-50 cursor-pointer ">
                <span className="text-gray-700 enable-staff-panel">
                  Track In/Out Time
                </span>

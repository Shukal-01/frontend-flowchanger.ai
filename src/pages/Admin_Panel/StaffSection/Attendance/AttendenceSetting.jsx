...
const AttendenceSetting = ({open, setOpen}) => {
        ...
        <div className=" ">
          <div className="">
            ...
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-[22px] acc-setting font-medium">
                Attendance Settings
              </h2>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="px-4 py-3 bg-gray-50 rounded-lg text-gray-600">
                Note: Attendance cannot be set to Auto as you have managers with
                attendance access
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <label className="flex items-start space-x-3 p-4 rounded-lg border border-gray-200 mb-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-gray-500">
                    Attendance is neutral by default, should be marked manually
                  </p>
                </div>
              </label>
              ...
              <label className="flex items-start space-x-3 p-4 rounded-lg border border-gray-200">
                ...
                <div className="space-y-1">
                  <p className="font-medium text-gray-700">
                    Selfie & Location Based
                  </p>
                  <p className="text-gray-500">
                    Staff can mark their own attendance with Selfie. Location
...
export default AttendenceSetting;

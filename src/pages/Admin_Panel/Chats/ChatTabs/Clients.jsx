    ...
    <>
      <div className="flex flex-col h-full justify-between">
        {Clients.map((Client) => {
          return (
            <div
              className="flex justify-start space-x-5 ml-2 space-y-2 hover:bg-purple-300 p-2 border border-gray-300 mb-2 rounded-lg shadow-lg bg-white"
              onClick={() => {
                handleShowChatSection();
                handleSelectedStaff(Client);
              }}
            >
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <p className="float-left  w-full text-gray-400">
                  {Client.message}
                </p>
              </div>
            </div>

...
const Add_Project = () => {
  ...
  async function projectSubmit(e) {
    ...
    const projectNameString =
      fetchProjectStatus.length > 0 ? fetchProjectStatus[0].project_name : ""; // Option 1, or use Option 2 as needed
  ...
  return (
    <div className="max-w-[80%] mx-auto add-project-form">
      <Tabs className="m-5  shadow-cs project-add-mar rounded-lg">
        <div className="">
          ...
          <form action="" onSubmit={projectSubmit}>
            <div className="w-[100%]  space-y-5">
                ...
                >
                  {clientData?.map((clientInformation, index) => {
                    console.log(
                      ...
                      clientInformation.clientDetails?.id
                    ); // Logs name and clientDetails.id

                    return (
                      <option
                        key={index}
                        value={clientInformation.clientDetails?.id}
                      >
              ...
              <div className="font-medium flex gap-3 items-center">
                ...
                <label for="text-[13px] font-medium progress-through ">
              ...
              <div className="flex w-[100%] gap-10 billing-form-type ">
                <div className="w-[50%] space-y-2 billing-type-project">
                  ...
                  <select
                    ...
                    className="h-[40px] w-[100%] focus-visible:outline-none bg-white border border-[#DBDCDE] rounded-md pl-5"
                    name="billingType"
                    required
                  >
                    <option value="Fixed Rate">Fixed rate</option>
                    <option value="Project Hours">Project Hours</option>
                    <option value="Task Hours Based on task hourly rate">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  type="number"
                  onChange={(e) => {
                    setRate(parseInt(e.target.value) || 0);
                  }}
                  required
                />
              </div>
            ...
            />
              ...
              <div className="flex justify-end gap-5  pb-[20px] ">
                <button
                  ...
                  className="bg-white text-[#27004a] border border-[#27004a] h-10 w-20 rounded-md"
                >
                  Cancel
                </button>

    ...
    <div className="flex flex-col gap-1 sm:flex-col lg:flex-row md:flex-col">
      <div className="addnewrole  pl-[10px] sm:w-[100%] lg:w-[50%] md:w-[100%] w-[100%] pr-2 mb-3 pb-4">
        ...
        <div className="bg-[#fff] shadow-cs p-3  md:w-[100%] sm:w-[100%] w-[100%] mt-2 rounded-md">
          ...
          <input
            type="text"
            className="mt-2 border border-1 pl-3 h-[43px] pr-7
 rounded-md focus:outline-none w-[100%] text-[15px] text-[#aeabab]"
          ...
          <table className="border mt-5 w-[100%] border-1">
            <thead className="border border-1 ">
              <tr>
                <th className="p-2 text-left font-medium border-r-[1px]">
                  Features
                </th>
            ...
            <tbody className="table-body-set">
              ...
              <tr className="border border-1">
                <td className="p-3 text-[14px] border-r-[1px] text-[#64748b] font-normal">
                  Clients
                </td>
                <td className="p-3">
                  <input
                  ...
                  />
                  <label className="ml-3 text-[13px] cursor-pointer text-[#64748b]">
                    View Global
                  </label>
                  <br />
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("clients_permissions", "create")
                    }
                  />
                  <label className="ml-2 cursor-pointer text-[13px] text-[#64748b]">
                    Create
                  </label>
                  <br />
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("clients_permissions", "edit")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Edit
                  </label>
                  <br />
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("clients_permissions", "delete")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Delete
              ...
              <tr className="border border-1">
                ...
                <td className="p-3">
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("projects_permissions", "create")
                    }
                  />
                  <label className="ml-2 cursor-pointer text-[13px] text-[#64748b]">
                    Create
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("projects_permissions", "edit")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Edit
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("projects_permissions", "delete")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Delete
              ...
              <tr className="border border-1">
                ...
                <td className="p-3">
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("staff_role_permissions", "create")
                    }
                  />
                  <label className="ml-2 cursor-pointer text-[13px] text-[#64748b]">
                    Create
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("staff_role_permissions", "edit")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Edit
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("staff_role_permissions", "delete")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Delete
              ...
              <tr className="border border-1">
                ...
                <td className="p-3">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("staff_permissions", "view_global")
                    }
                  />
                  <label className="ml-3 text-[13px] cursor-pointer text-[#64748b]">
                    View Global
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("staff_permissions", "create")
                    }
                  />
                  <label className="ml-2 cursor-pointer text-[13px] text-[#64748b]">
                    Create
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("staff_permissions", "edit")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Edit
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("staff_permissions", "delete")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Delete
              ...
              <tr className="border border-1">
                ...
                <td className="p-3">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("task_permissions", "view_global")
                    }
                  />
                  <label className="ml-3 text-[13px] cursor-pointer text-[#64748b]">
                    View Global
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("task_permissions", "create")
                    }
                  />
                  <label className="ml-2 cursor-pointer text-[13px] text-[#64748b]">
                    Create
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("task_permissions", "edit")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Edit
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("task_permissions", "delete")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Delete
              ...
              <tr className="border border-1">
                ...
                <td className="p-3">
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("sub_task_permissions", "create")
                    }
                  />
                  <label className="ml-2 cursor-pointer text-[13px] text-[#64748b]">
                    Create
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("sub_task_permissions", "edit")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Edit
                  ...
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("sub_task_permissions", "delete")
                    }
                  />
                  <label className="ml-3 cursor-pointer text-[13px] text-[#64748b]">
                    Delete
          ...
          <div className="flex justify-end mt-3 gap-2">
            <Link to="/role-detail" className="first-btn flex items-center">
              Cancel
            </Link>
            <button
      ...
      <div className="staff-member w-[100%] sm:w-[100%] lg:w-[50%] md:w-[100%]">
        ...
        <div className="bg-[#fff] shadow-cs   p-2 rounded-md mt-2">
          ...
          <div className="">
            <h2 className="p-2 bg-[#fff] shadow-cs rounded-md border border-l-0 mb-2 border-r-0 border-t-1 border-b-1 ">
              Full Name
            </h2>

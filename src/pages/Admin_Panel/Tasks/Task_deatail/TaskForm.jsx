...
const TaskForm = () => {
    ...
    try {
      ...
      const result = await fetch(baseUrl + "task/detail", {
        ...
        body: JSON.stringify({
          ...
          taskPriorityId: selectedTaskPriorityId,
          selectProjectId: selectedProjectId,
          taskAssign: selectedStaffIds,
          taskTag: tag,
        }),
      });
  ...
  return (
    <div className="w-[100%]  form-main flex justify-center mt-[30px] mb-[30px] items-center min-h-screen">
      <div className="bg-white p-6 rounded-lg shadow-cs xl:w-[80%] lg:w-[80%] w-[80%] relative h-[100%]  ">
        ...
        <form action="" onSubmit={submitTask}>
          <div className="w-[100%]">
            ...
            <div className="">
              ...
              <br />
              <div className="w-[100%]">
                <label className="text-[13px] xl:text-[14px] text-[#000000ba] font-medium mb-3">
                ...
                <input
                  ...
                  className=" mb-[10px]  pr-2 focus:outline-none tag-input mt-2"
                  placeholder="Tag"
                  required
                />{" "}
                <br />
